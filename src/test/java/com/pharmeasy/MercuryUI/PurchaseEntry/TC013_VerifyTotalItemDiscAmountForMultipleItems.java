...
public class TC013_VerifyTotalItemDiscAmountForMultipleItems extends TestBase{

	
	public static final Logger log = Logger.getLogger(TC013_VerifyTotalItemDiscAmountForMultipleItems.class.getSimpleName());
	
	@Test
	public void verifyTotalDiscAmt() throws InterruptedException {
		...
		double calculatedTotalItemDisc = new BigDecimal(purchaseEntry.getCalculatedFooterDetailsFromItemTable().get("Total Item Disc.")).setScale(2,RoundingMode.HALF_UP).doubleValue();
		
		Assert.assertEquals(purchaseEntry.getFooterDetails().get("Total Item Disc."), calculatedTotalItemDisc);
