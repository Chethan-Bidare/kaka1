...
public class TC015_VerifyTotalSchDiscAmtForMultipleItems extends TestBase{

	public static final Logger log = Logger.getLogger(TC015_VerifyTotalSchDiscAmtForMultipleItems.class.getSimpleName());
	
	@Test
	public void verifyTotalSchDiscAmtForMultipleItems() throws InterruptedException {
		...
		double calculatedTotalSchDiscAmt = new BigDecimal(purchaseEntry.getCalculatedFooterDetailsFromItemTable().get("Total Sch Disc")).setScale(2,RoundingMode.HALF_UP).doubleValue();
		
		Assert.assertEquals(purchaseEntry.getFooterDetails().get("Total Sch Disc"), calculatedTotalSchDiscAmt);
