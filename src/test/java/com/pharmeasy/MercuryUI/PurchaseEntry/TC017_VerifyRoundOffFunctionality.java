...
public class TC017_VerifyRoundOffFunctionality extends TestBase{

public static final Logger log = Logger.getLogger(TC017_VerifyRoundOffFunctionality.class.getSimpleName());
	
	@Test
	public void verifyRoundOff() throws InterruptedException {
		...
		purchaseEntry.enterRoundOffValue("10");
		Thread.sleep(1000);
		double invAmtAftRoundOff = purchaseEntry.getFooterDetails().get("Total Invoice Amt");
		double actualRoundOff = new BigDecimal(invAmtAftRoundOff-invAmt).setScale(2, RoundingMode.HALF_UP).doubleValue();
		Assert.assertEquals(actualRoundOff,10.0) ;
