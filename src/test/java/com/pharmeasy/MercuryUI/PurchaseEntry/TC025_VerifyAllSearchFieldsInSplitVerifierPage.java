...
public class TC025_VerifyAllSearchFieldsInSplitVerifierPage extends TestBase{

	
public static final Logger log = Logger.getLogger(TC025_VerifyAllSearchFieldsInSplitVerifierPage.class.getSimpleName());
