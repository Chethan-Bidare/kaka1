...
public class TC026_VerifyPurchaseCreationInSplitVerifier extends TestBase{

	public static final Logger log = Logger.getLogger(TC026_VerifyPurchaseCreationInSplitVerifier.class.getSimpleName());
	
	/*
	 * Create a purchase Entry from Purchase Entry page 
	 * Verify that Purchase in Split Verifier page
	 */
	
	@Test
	public void verifyPurchaseCreationInSplitVerifier() throws InterruptedException {
